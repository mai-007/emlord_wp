...
function mr_the_archive_pager($the_query)
{
  ...
  if ($max_page !== 1) {
    ...
    while ($prev > 0) {
      ...
      $html .= '<li class="c-pager__li"><a href="' . esc_url($base_url . 'page/' . $prev_nth . '/' . $url_param) . '">' . $prev_nth . '</a></li>';
      $prev--;
    }
    ...
    while ($next > 0) {
      $next_nth = $page_nth + $i;
      $html .= '<li class="c-pager__li"><a href="' . esc_url($base_url . 'page/' . $next_nth . '/' . $url_param) . '">' . $next_nth . '</a></li>';
      $next--;
      $i++;
    }
    ...
    if ($key_l) {
      $html .= '<li class="c-pager__dots">...</li>';
      $html .= '<li class="c-pager__li"><a href="' . esc_url($base_url . 'page/' . $max_page . '/' . $url_param) . '">' . $max_page . '</a></li>';
    }
