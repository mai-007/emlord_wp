...
<body id="<?php echo esc_attr($post->post_name); ?>" <?php body_class(); ?>>
  ...
  <div class="l-headerSub">
    ...
    <picture class="l-headerSub__image">
      ...
      <source media="(min-width:800px)" srcset="<?php echo get_theme_img('headerImage/coating@2x.jpg'); ?>"
        sizes="100vw">
    ...
    <picture class="l-headerSub__image">
      ...
      <source media="(min-width:800px)" srcset="<?php echo get_theme_img('headerImage/aircon@2x.jpg'); ?>"
        sizes="100vw">
    ...
    <picture class="l-headerSub__image">
      ...
      <source media="(min-width:800px)" srcset="<?php echo get_theme_img('headerImage/repair@2x.jpg'); ?>"
        sizes="100vw">
    ...
    <?php if (is_page(14)) : ?>
    <picture class="l-headerSub__image">
      <source media="(max-width:799px)" srcset="<?php echo get_theme_img('headerImage/insurance.jpg'); ?>"
        sizes="100vw">
      <source media="(min-width:800px)" srcset="<?php echo get_theme_img('headerImage/insurance.jpg'); ?>"
        sizes="100vw">
    ...
    <?php if (is_page(13)) : ?>
    <picture class="l-headerSub__image">
      <source media="(max-width:799px)" srcset="<?php echo get_theme_img('headerImage/inspection.jpg'); ?>"
        sizes="100vw">
      <source media="(min-width:800px)" srcset="<?php echo get_theme_img('headerImage/inspection.jpg'); ?>"
        sizes="100vw">
    ...
    <?php if (is_page(29)) : ?>
    <picture class="l-headerSub__image">
      <source media="(max-width:799px)" srcset="<?php echo get_theme_img('headerImage/sd_youtube.jpg'); ?>"
        sizes="100vw">
      <source media="(min-width:800px)" srcset="<?php echo get_theme_img('headerImage/sd_youtube@2x.jpg'); ?>"
        sizes="100vw">
    ...
    <picture class="l-headerSub__image">
      <source media="(max-width:799px)" srcset="<?php echo get_theme_img('headerImage/radiator.jpg'); ?>" sizes="100vw">
      <source media="(min-width:800px)" srcset="<?php echo get_theme_img('headerImage/radiator@2x.jpg'); ?>"
        sizes="100vw">
    ...
    <picture class="l-headerSub__image">
      ...
      <source media="(min-width:800px)" srcset="<?php echo get_theme_img('headerImage/energy@2x.jpg'); ?>"
        sizes="100vw">
  ...
  <!-- 店舗詳細ページ -->
  <?php $post_type = get_post_type(); ?>
  <?php if ($post_type == 'store' || is_post_type_archive('store')) : ?>
  <div class="l-headerSub">
    <div class="l-headerSub__inner">
  ...
  <?php elseif ($post_type == 'store' || is_single('store')): ?>
  <div class="l-headerSub">
    <div class="l-headerSub__inner">
